...
void scaleToFastSize(const cv::Mat &src,cv::Mat &dst) {
	//std::cout << "cols:  "<<src.cols<<"  rows:  "<<src.rows<<"  scaling-factor:  " << cv::Size(kFastEyeWidth, (((float)kFastEyeWidth) / src.cols) * src.rows) << std::endl;
