...
float delta_alpha = 0.5; int delta_beta = -50;
...
string Time, Data;
void NormExecution(Mat frame2,int countFrame,int NumMaxFrame, int NumImageToSelect,std::vector<float>meanAlls,std::vector<Mat>faces, std::vector<Mat>facesWhitened) {
